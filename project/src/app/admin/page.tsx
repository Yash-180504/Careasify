...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { label: 'New Inquiries', value: stats?.newInquiries || 0, icon: '📩', color: 'rgba(124,58,237,0.15)' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-lg)', marginTop: 'var(--space-lg)' }}>
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
            <Link href="/admin/inquiries" className="btn btn-primary">📩 View Inquiries</Link>
            <Link href="/admin/bookings" className="btn btn-secondary">📋 Manage Bookings</Link>
