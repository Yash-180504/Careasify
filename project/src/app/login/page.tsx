    ...
    <div className="auth-page">
      <div className="auth-card">
        <Link href="/" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 'var(--space-xl)' }}>
          <Image src="/icons/careas-logo.png" alt="Careasify" width={40} height={40} style={{ borderRadius: 8 }} />
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input id="login-email" className="form-input" type="email" placeholder="admin@careasify.com" value={email} onChange={(e) => setEmail(e.target.value)} required />
          </div>
          <div className="form-group">
