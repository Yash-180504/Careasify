        ...
        <div className="footer-grid">
          <div>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '8px' }}>
              {/* Call */}
              <a href="tel:+917022099595" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/917022099595" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Instagram */}
              <a href="https://instagram.com/careasify" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {/* Facebook */}
              <a href="https://facebook.com/careasify" target="_blank" rel="noopener noreferrer" style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
